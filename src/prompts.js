...
COMPANY CONTEXT (already known — do not ask about this):
${companyContext}

Use this context to skip questions whose answers are already implied. For example, if the company is a regulated financial institution, do not ask about regulatory requirements — you already know them. If the company operates globally, scale questions may be skippable unless the scope implies a specific regional deployment.` : "";
...
The bullets should be 6-10 clear factual statements. Include the company name and any relevant regulatory context that would affect vendor selection. No other text before or after.`;
}
