                          ...
                          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 10 }}>
                            ...
                            <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-end", gap: 5, flexShrink: 0 }}>
                              ...
                              <div style={{ display: "flex", gap: 5 }}>
                                ...
                                {v.vendorUrl && <a href={v.vendorUrl} target="_blank" rel="noopener noreferrer" style={{ textDecoration: "none" }}><button className="vendor-btn vendor-btn-g2" style={{ background: "rgba(168,200,216,0.08)", borderColor: "rgba(168,200,216,0.2)", color: "#a8c8d8" }}>Web ↗</button></a>}
                                {!v.g2Url && !v.vendorUrl && <a href={`https://www.google.com/search?q=${encodeURIComponent(v.name + " ' + v.category + '")}"`} target="_blank" rel="noopener noreferrer" style={{ textDecoration: "none" }}><button className="vendor-btn vendor-btn-g2" style={{ background: "rgba(168,200,216,0.08)", borderColor: "rgba(168,200,216,0.2)", color: "#a8c8d8" }}>Search ↗</button></a>}
                              </div>
                            </div>
                          </div>
